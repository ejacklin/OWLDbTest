...
CREATE TABLE `strength` (
  ...
  UNIQUE KEY `strength_strength_id_uindex` (`strength_id`),
  UNIQUE KEY `strength_exercise_id_uindex` (`exercise_id`),
  CONSTRAINT `strength_exercise_id_fk` FOREIGN KEY (`exercise_id`) REFERENCES `exercise` (`exercise_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `strength` VALUES (1,12,3,200,1),(2,1,5,14,3);
...
-- Dump completed on 2017-08-17  0:16:48
